...
enum GeneratorError: Error, LocalizedError {
  ...
  var errorDescription: String? {
    ...
    case .invalidRepositoryStructure:
      return "Unable to infer repository root from script location. Expected path structure: targets/watch/Scripts/<script>."
    }
  }
}
...
func resolvePaths() throws -> (catalogueURL: URL, outputURL: URL) {
  ...
  let targetsDirectory = watchDirectory.deletingLastPathComponent()
  let repoRoot = targetsDirectory.deletingLastPathComponent()

  guard watchDirectory.lastPathComponent == "watch",
        targetsDirectory.lastPathComponent == "targets" else {
  ...
  // Path: targets/watch/Generated/Brands.swift
...
func generateSource(from catalogue: CatalogueData) -> String {
  ...
  let brands = catalogue.brands
    .map { brand in
      ...
      return
        "    .init(id: \"\(swiftStringLiteral(brand.id))\", logoUrl: \"\(swiftStringLiteral(logoUrl))\", name: \(optionalLiteral(brand.name)), aliases: \(aliasesLiteral(brand.aliases)))"
    }
    .joined(separator: ",\n")

  return """
    // DO NOT EDIT — This file is auto-generated.
    // Generated by targets/watch/Scripts/generate-catalogue.swift
