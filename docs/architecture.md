...
- `targets/watch/`: Source lives here, but Xcode project is generated by `expo prebuild` inside `ios/`. No standalone Xcode project — developers open `ios/Cardi.xcworkspace` and select the watch scheme.
