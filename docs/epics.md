...
**Therefore there is no decode fix, and the story is about honest failure handling.** The app's own defect is that it reports "No barcode found in this image" — untrue, since Android reads it — with no route forward and no telemetry.
